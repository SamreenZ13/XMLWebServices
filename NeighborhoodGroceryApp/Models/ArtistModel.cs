...
namespace NeighborhoodGroceryApp
{
    ...
    public partial class Empty
    {
        public static Empty[] FromJson(string json) => JsonConvert.DeserializeObject<Empty[]>(json, NeighborhoodGroceryApp.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Empty[] self) => JsonConvert.SerializeObject(self, NeighborhoodGroceryApp.Converter.Settings);
    }
